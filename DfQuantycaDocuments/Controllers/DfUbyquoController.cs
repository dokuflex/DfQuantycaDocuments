...
namespace DfQuantycaDocuments.Controllers
{
    ...
    public class DfUbyquoController : ApiController
    {
        ...
        [Route("docs/uploadv2/")]
        [HttpPost]
        public async Task<IHttpActionResult> uploadDocument2()
        {
            WriteToTrace("Controllers", "Start upload document", System.Web.Http.Tracing.TraceLevel.Info);
            ...
            try
            {
                ...
                */
                ...
                {
                    WriteToTrace("Controllers", "File null or invalid.", System.Web.Http.Tracing.TraceLevel.Error);
                    return BadRequest("File invalid.");
                }

                WriteToTrace("Controllers", "Try to create file in: " + ubyquoImportPath + fileName, System.Web.Http.Tracing.TraceLevel.Info);
                File.WriteAllBytes(ubyquoImportPath +"\\"+ fileName, files.FirstOrDefault().Value);
